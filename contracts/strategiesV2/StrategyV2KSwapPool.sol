...
import "../../interfaces/IKSwapPool.sol";
import "../../interfaces/IKSwapSwapPool.sol";

import "../interfaces/IStrategyV2SwapPool.sol";
import "../utils/TenMath.sol";

// https://app.kswap.finance/

// Connecting to third party swap for pool lptoken
contract StrategyV2KSwapPool is IStrategyV2SwapPool {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    IUniswapV2Factory public constant factory = IUniswapV2Factory(0x60DCD4a2406Be12dbe3Bb2AaDa12cFb762A418c1);
    IUniswapV2Router02 public constant router = IUniswapV2Router02(0xc3364A27f56b95f4bEB0742a7325D67a04D80942);

    IKSwapPool public constant farmpool = IKSwapPool(0xaEBa5C691aF30b7108D9C277d6BB47347387Dc13);
    IKSwapSwapPool public constant swappool = IKSwapSwapPool(0x1FcCEabCd2dDaDEa61Ae30a2f1c2D67A05fDDa29);
    address public constant rewardToken = address(0xab0d1578216A545532882e420A8C61Ea07B00B12);

    address public strategy;

    constructor() public {
        require(false, 'kswap not support withdraw');
    }
    ...
    function getPending(uint256 _poolId) external override view returns (uint256 rewards) {
        rewards = farmpool.pendingKst(_poolId, address(this));
    }
