...
import "./SafeBoxFoxCTokenImpl.sol";

contract SafeBoxFoxCToken is SafeBoxFoxCTokenImpl, ReentrancyGuardUpgradeable, OwnableUpgradeable, ICompActionTrigger, ISafeBox {
    ...
    function __SafeBoxFoxCToken_init(address _bank, address _cToken, address _devAddr) public initializer {
        __Ownable_init();
